...
const form = () => {
  ...
  const get_or_search_ts03 = useInfiniteQuery<TS02ListData>({
    queryKey: [
      "get_or_search",
  ...
  const _onMomentumScrollEnd = ({
    ...
    if (isCloseToBottom) {
      if (
        get_or_search_ts03.data?.pages[get_or_search_ts03.data.pages.length - 1]
          .is_more !== 0 &&
        get_or_search_ts03.hasNextPage
      )
        get_or_search_ts03.fetchNextPage();
    }
  };

  const refresh = () => {
    get_or_search_ts03.refetch();
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <CusHeader title="TS-03"></CusHeader>
      <ScrollView
        style={styles.scrol}
        onMomentumScrollEnd={_onMomentumScrollEnd}
        refreshControl={
          <RefreshControl
            refreshing={get_or_search_ts03.isFetching}
            onRefresh={refresh}
          />
        }
      ...
      >
        ...
        >
          ...
          {get_or_search_ts03.isSuccess &&
            get_or_search_ts03.data.pages.map((_item, i) =>
